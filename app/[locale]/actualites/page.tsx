          ...
          <div>
            {news.map(item => (
              <Link
                ...
                className="group flex gap-6 border-t border-foreground/15 py-6 hover:border-royal/30 transition-colors duration-300 items-start"
              >
                {item.imageSrc && (
                  <div className="relative w-32 h-24 shrink-0 overflow-hidden bg-foreground/[0.05] hidden sm:block">
                    <Image
                      src={item.imageSrc}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="font-heading text-xl text-foreground group-hover:text-royal transition-colors leading-tight mb-2">
