      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-accent-blue/10 border border-accent-blue/20 rounded-2xl p-6 mb-16">
          <p className="text-sm text-foreground">
            <strong>Programme Accès-Loisirs :</strong> le Club de Judo Boucherville participe au programme de la Ville de Boucherville offrant des tarifs réduits aux résidents admissibles. Renseignez-vous auprès de la Ville ou contactez-nous.
          </p>
        </div>
        <h2 className="font-heading text-3xl text-foreground tracking-wider mb-8">Questions fréquentes</h2>
        <div className="space-y-4">
          {faq.map(item => (
            <details key={item.q} className="group bg-bg-surface border border-white/5 rounded-xl overflow-hidden">
              ...
              <div className="px-5 pb-5 text-muted text-sm leading-relaxed border-t border-white/5">{item.a}</div>
            </details>
          ))}
        </div>
        <div className="mt-16 text-center bg-bg-surface border border-white/5 rounded-2xl p-8">
          <h3 className="font-heading text-2xl text-foreground tracking-wider mb-2">Des questions?</h3>
