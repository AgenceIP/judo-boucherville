        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.facebook.com/clubdejudoboucherville" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-gold transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/judoboucherville" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-gold transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@judoboucherville" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-gold transition-colors" aria-label="TikTok">
              ...
              <a href="https://www.youtube.com/@judoboucherville" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-gold transition-colors" aria-label="YouTube">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex gap-3 text-sm">
                ...
                <a href="tel:4506551888" className="text-foreground hover:text-gold transition-colors">
                  (450) 655-1888
                </a>
              </li>
              <li className="flex gap-3 text-sm">
                <Mail size={16} className="text-accent-blue shrink-0" />
                <a href="mailto:info@judoboucherville.com" className="text-foreground hover:text-gold transition-colors">
