...
export default function Footer() {
  ...
  return (
    <footer className="bg-royal border-t border-white/30">
      ...
      <div ref={wordmarkRef} className="overflow-hidden pt-14 -mb-4">
        <button
          ...
          className="text-stroke wordmark font-heading text-center leading-[.85] select-none whitespace-nowrap block w-full"
          style={{ fontSize: 'clamp(34px, 6.4vw, 118px)' }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <span className="font-heading text-2xl tracking-widest text-white">
              JUDO<span className="text-white">·</span>BOUCHERVILLE
            </span>
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.facebook.com/clubdejudoboucherville" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-black transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/judoboucherville" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-black transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@judoboucherville" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-black transition-colors" aria-label="TikTok">
              ...
              <a href="https://www.youtube.com/@judoboucherville" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-black transition-colors" aria-label="YouTube">
          ...
          {/* Quick links */}
          <div>
            <h3 className="font-heading text-sm tracking-widest text-white/70 uppercase mb-4">
            ...
            <ul className="space-y-2">
              {schedules.map(s => (
                <li key={s.label} className="text-sm">
                  ...
                  <span className="text-white/70 block">{s.time}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-heading text-sm tracking-widest text-white/70 uppercase mb-4">Contact</h3>
            <ul className="space-y-3">
              <li className="flex gap-3 text-sm">
                <MapPin size={16} className="text-white shrink-0 mt-0.5" />
                <span className="text-white">490 chemin du Lac<br />Boucherville (QC) J4B 6X3</span>
              </li>
              <li className="flex gap-3 text-sm">
                <Phone size={16} className="text-white shrink-0" />
                <a href="tel:4506551888" className="text-white hover:text-black transition-colors">
                  (450) 655-1888
                </a>
              </li>
              <li className="flex gap-3 text-sm">
                <Mail size={16} className="text-white shrink-0" />
                <a href="mailto:info@judoboucherville.com" className="text-white hover:text-black transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-white/30 flex flex-col items-center gap-3 text-center text-sm text-white/70">
